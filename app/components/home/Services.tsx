    ...
    return (
        <div className="py-4">
            <p className="text-sm text-[#121212]">
                Manilla empowers Canadian businesses with modern invoicing tools. Whether freelance or enterprise, bill clients worldwide and get paid in crypto. Create branded invoices in seconds, accept USDT, USDC, ETH, and BTC, and receive real-time payment alerts. Hold crypto or auto-convert to CAD (coming soon) to stay ahead with seamless, stable settlements.
            </p>
        </div>
    )
}
function ApiContent() {
    return (
        <div className="py-4 text-sm lg:text-base">
            <p className="text-[#121212]">Accept crypto payments directly on your website—fast, secure, and borderless. With Manilla’s plug-and-play API or plugins, integration takes minutes. Customers enjoy seamless checkout without leaving your site. Instantly receive funds in your Manilla wallet. Built for developers with clear docs, sandbox tools, and support to get you live quickly.</p>
        </div>
    )
}
